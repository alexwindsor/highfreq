...
<template>
    ...
    >
        ...
        >
            ...
            <div v-else>
                <div class="inline-block whitespace-nowrap sm:whitespace-normal">
                    {{ props.log?.datetime.substring(11, 16) }}
                    <span class="whitespace-nowrap">{{ props.log?.datetime.substring(8, 10) }}/{{ props.log?.datetime.substring(5, 7) }} '{{ props.log?.datetime.substring(2, 4) }}</span>
                </div>
            </div>
        </div>
...
<!--                <div>{{ Math.round(log.quality * 100) / 100 }}/3</div>-->
                <br>
            </div>
        </div>
