    ...
    <div class="sm:grid sm:grid-cols-2 sm:gap-7 md:gap-10 lg:grid-cols-1 lg:gap-0 border-l border-b border-black p-4 sm:mb-10">
        ...
        <div class="mx-auto mb-8 w-full xl:w-5/6">
            <label class="inline-block bg-gray-300 mr-3 mb-1.5">
                Time?
                <input type="checkbox" v-model="logs.filters.time_filter" @change="logs.updateLogs('time_filter')"
                       class="">
            </label>
            <div v-if="logs.filters.time_filter" class="ml-4">
                ...
                <br>
                <label class="inline-block bg-gray-300 my-1.5">
                    Now?
                    <input
                        type="checkbox"
                        v-model="logs.filters.make_time_now"
                        @change="logs.updateLogs('make_time_now')">
                </label>
                ...
                <label class="inline-block bg-gray-300 my-1.5">
                    ...
                    <input
                        type="checkbox"
                        v-model="logs.filters.half_hour_blocks"
                        @change="changeTime"
                    >
                </label>
                <br>
        ...
        <div class="mx-auto w-full mb-2 xl:w-5/6">
            <label class="bg-gray-300">
                Show everyone's logs
                <input
                    type="checkbox"
                    v-model="logs.filters.log_owners"
                    @change="logs.updateLogs"
                >
            </label>
        </div>
        ...
        <!-- frequency -->
        <div class="mx-auto my-6 w-full xl:w-5/6">
