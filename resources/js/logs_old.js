...
export let logs = reactive({
    ...
    addSwinfoMatch(swinfo_match_key) {
        ...
        this.newlog.programme_id = this.swinfoMatches[swinfo_match_key].programme_id
        ...
        this.triggerProgrammes.pickStation(this.newlog.station_id, this.newlog.station_name)
    ...
    deleteLog(log_id, frequency, station, language) {
        ...
        if (this.edit_mode === log_id) this.edit_mode = 0
