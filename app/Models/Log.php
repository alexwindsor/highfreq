...
class Log extends Model
{
    ...
    protected function scopeSwInfoMatch(Builder $query, bool $match_swinfo, bool $antimatch_swinfo): void
    {
        ...
        $swInfoBroadcastUpdate_id = SwInfoBroadcastUpdate::getLatestUpdate('id');
        ...
        $query->whereRaw('
            ...
            WHERE `sw_info_broadcasts`.`sw_info_broadcast_updates_id` = ' . $swInfoBroadcastUpdate_id . ' 
            AND `sw_info_broadcasts`.`weekdays` & ' . $day . ' AND 
            IF(
